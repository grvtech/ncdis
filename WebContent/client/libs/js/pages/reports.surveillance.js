...
var report = loadReportFile("locallist");
...
function buildStatsFrame(){
	...
	$("#s2").empty();
	$("#s2")
	.append($("<div>",{class:"title"}).html("<b>NO</b> A1C measurement in  <span>"+$('#dp-filter option[value="'+appFilter.dp+'"]').text()+"</span>"))
...
function loadReportFile(reportID){
